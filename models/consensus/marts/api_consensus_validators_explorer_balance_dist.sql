{{
    config(
        materialized='view',
        tags=["production", "consensus", 'tier1', 'api:validators_explorer_balance_dist', 'granularity:latest'],
        meta={
            "api": {
                "methods": ["GET", "POST"],
                ...
                "parameters": [
                    {
                        ...
                        "type": "string",
                        "case": "lower",
                        "description": "Withdrawal credential (32-byte hex) — returns balance histogram across co-validators"
                    }
                ],
                "pagination": {
                    "enabled": true,
                ...
                "sort": [
                    {"column": "bucket_order", "direction": "ASC"}
                ]
            }
        }
    )
