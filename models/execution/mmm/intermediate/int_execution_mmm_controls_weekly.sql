{{
  config(
    ...
    order_by='(week, control_name)',
    unique_key='(week, control_name)',
    partition_by='toStartOfMonth(week)',
    settings={'allow_nullable_key': 1},
    tags=['production', 'mmm', 'execution']
  )
}}
