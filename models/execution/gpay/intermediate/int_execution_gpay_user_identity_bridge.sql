...
safe_self AS (
    SELECT
        ...
        {{ pseudonymize_address("if(c.canonical_address != '', c.canonical_address, gs.gp_safe)") }} AS user_pseudonym,
...
migrated_links AS (
    SELECT
        ...
        {{ pseudonymize_address('c.canonical_address') }}  AS user_pseudonym,
