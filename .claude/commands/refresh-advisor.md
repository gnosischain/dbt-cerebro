...
command. The user's input: $ARGUMENTS (a model name, optionally with a description of
what happened — e.g. "a raw backfill landed for March" or "needs full history rebuild").
